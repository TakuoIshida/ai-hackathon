...
CREATE UNIQUE INDEX "uniq_bookings_active_slot" ON "bookings" USING btree ("link_id","start_at") WHERE "bookings"."status" = 'confirmed';--> statement-breakpoint
...
CREATE INDEX "idx_availability_rules_link" ON "availability_rules" USING btree ("link_id");--> statement-breakpoint
CREATE UNIQUE INDEX "uniq_link_owner" ON "link_owners" USING btree ("link_id","user_id");--> statement-breakpoint
CREATE INDEX "idx_link_owners_user" ON "link_owners" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "uniq_workspace_email_open" ON "invitations" USING btree ("workspace_id","email") WHERE accepted_at IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "uniq_workspace_user" ON "memberships" USING btree ("workspace_id","user_id");